    ...
    <div className="w-72 h-auto p-4 m-1.5 rounded-lg overflow-hidden bg-white transition-all duration-500 shadow-md cursor-pointer hover:shadow-lg hover:scale-110 hover:transtion-all ease-in-out">
      <div className="flex flex-col items-center justify-around w-full h-full">
        ...
        <button
          ...
          className="my-2.5 p-2 w-32 font-bold cursor-pointer rounded-xl bg-transparent border-solid border-2 border-black hover:bg-black hover:text-white transition-all duration-600 ease-in"
        >
          Agregar al Carrito
        </button>
      </div>
